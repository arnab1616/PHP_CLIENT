                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="error-images">
                                <!-- <img src="assets/Image/images/error.png" alt="Error"> -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="error-content">
                                ...
                                <h2 class="main-title">We Are Sorry, But The Page <span>You Requested Was Not</span> Found.</h2>
                                <a href="https://igrowplusplus.com/" class="btn btn-primary btn-hover-dark">Back To Home</a>
                            </div>
                            <!-- Error Content End -->
                        </div>
                    </div>
